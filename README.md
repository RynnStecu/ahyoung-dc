...
<img src="https://capsule-render.vercel.app/api?type=waving&color=5865F2&height=120&section=header" width="100%"/>

<a href="#top"></a>

<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=32&duration=2500&pause=800&color=5865F2&center=true&vCenter=true&width=600&lines=Ahyoung+Discord+Bot+Base;Ringan+%E2%80%A2+Modular+%E2%80%A2+Hot-Reload;Dibangun+dengan+Node.js+ESM" alt="Typing SVG" />
...
**Discord bot base ringan, modular, dan hot-reload — dilengkapi level system, welcome card, dan web dashboard owner-only.**

</div>

<img src="https://capsule-render.vercel.app/api?type=rect&color=5865F2&height=3&width=100%25" width="100%"/>
...
- [🚇 PM2 + Cloudflare Tunnel](#-jalankan-dengan-pm2--cloudflare-tunnel)
- [💬 Menu Interaktif](#-menu-interaktif)
- [💌 Dukungan Guild & DM](#-dukungan-guild--dm)
- [🔌 Membuat Plugin & Event](#-cara-membuat-plugin-baru)
...
| 🖥️ **CMD Logger** | Setiap command yang dipakai user otomatis terlog di konsol |
...
| 🖥️ **Web Dashboard** | Owner-only (login Discord OAuth2) — user, leaderboard, plugin, server, broadcast |
| 🚇 **PM2 + Cloudflare Tunnel** | `ecosystem.config.js` siap pakai, auto-install `cloudflared` kalau belum ada |
...
<details>
<summary><b>🐧 Linux / Ubuntu Server / Debian</b></summary>
<br/>
...
<details>
<summary><b>🪟➡️🐧 Windows WSL</b></summary>
<br/>
...
> 💡 Jalankan `termux-wake-lock` supaya proses bot tidak dimatikan sistem saat layar terkunci.
...
<details>
<summary><b>🆔 Cara Mendapatkan Client ID</b></summary>
<br/>
...
<details>
<summary><b>🔐 Cara Mendapatkan Client Secret & Setup Redirect URI (buat Dashboard)</b></summary>
<br/>
...
<details>
<summary><b>➕ Cara Invite Bot ke Server</b></summary>
<br/>
...
<details>
<summary><b>Klik untuk lihat struktur folder lengkap</b></summary>
...
1. Isi `global.clientSecret` dan `global.dashboardConfig.redirectUri` di `setting.js` (lihat [Cara Mendapatkan Client Secret](#-konfigurasi) di atas).
...
<details>
<summary><b>⚙️ Setup Tunnel (sekali saja)</b></summary>
<br/>
...
**Isi Token ke Ecosystem** — buka `ecosystem.config.js`, ganti token di app `ahyoung-tunnel`:
...
**Update Redirect URI Dashboard** karena sekarang punya domain publik:

```js
global.dashboardConfig.redirectUri = "https://dashboard.kyzzz.eu.cc/auth/discord/callback"
```

Lalu daftarkan URL yang sama persis di Developer Portal → OAuth2 → Redirects.
...
<details>
<summary><b>📸 Preview Menu</b></summary>
<br/>
...
<details>
<summary><b><code>!addp</code> — Tambah Plugin (Interaktif)</b></summary>
<br/>
...
<details>
<summary><b>Klik untuk lihat tabel troubleshooting lengkap</b></summary>
...
| `pm2 start ecosystem.config.js` gagal jalanin tunnel | Cek `pm2 logs ahyoung-tunnel` — biasanya karena `TUNNEL_TOKEN` belum diisi/salah, atau OS tidak didukung script auto-install. |
...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=18&duration=3000&pause=1000&color=FF69B4&center=true&vCenter=true&width=400&lines=Created+with+%E2%9D%A4%EF%B8%8F+by+KyuDev" alt="footer typing" />
